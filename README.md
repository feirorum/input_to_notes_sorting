...
Experimentation repo for the part of a notes, knowledgebase, snippet recording system which
sorts input snippets, information to available categories, notes.

The idea is to have automatic input from podcast heard, youtube watched and then tags, sorts them according to a system 
set up by the user. 
